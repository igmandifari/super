...
<body>	
	...
	<table class="table table-hover" style="width:80%; padding:100px;">
		<tr>
			<td colspan="3">
				<h1 style="text-align:center;">RAIL FENCE DESKRIPSI</h1>
			</td>
		</tr>
		<tr>
			<td>CipherText</td>
		...
		<tr>
			<td colspan="3">
				...
				<input name="btnDe" class="btn btn-primary" value="Deskripsi" onclick="Decrypt()" type="button">
			</td>
    ...
    <div class="bawahan">
        ...
        <a class="btn btn-success" href="railfence-enkripsi.php" role="button">Enkripsi</a></p>
    </div>
</div><!-- /.container -->
