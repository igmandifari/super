...
<body>	
	...
	<div class="container">
        ...
        <tr>
			<td colspan="3">
				<h1 style="text-align:center;">CAESAR CIPHER ENKRIPSI</h1>
			</td>
		</tr>
  ...
  <div class="box box-info">
      ...
      <p class="login-box-msg" style="font-size:20px !important"><b></b></p>    
              <form name="enkripsi" method="post" style="width:80%;" >
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <textarea name="plain" required="true" oninvalid="this.setCustomValidity('Tidak boleh kosong!')" 
                                 oninput="setCustomValidity('')" type="text" class="form-control" name="p" rows="4"  placeholder="Masukan Plain Text"></textarea>            
                  </div>
                  <div class="form-group">
                    <label>Keyword :</label>
                ...
                <div class="box-footer">
                    <table class="table table-hover" style="width:80%; padding:100px;">
                        <tr>
                            <td><input type="submit" name="submit1" value="Encrypt" style="width: 80px" class="btn btn-success"></td>
            ...
            <a class="btn btn-primary" href="caesar-deskripsi.php" role="button">Dekripsi</a></p>
        </div>
        <br>
        <br>
                  </div>
